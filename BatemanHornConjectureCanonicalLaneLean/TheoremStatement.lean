...
This module internalizes the theorem-facing object for `bateman-horn-conjecture-canonical-lane`
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate for Bateman-Horn Conjecture internalized through baseline gates, source constants, reviewer bridge, manifest hashes, outside-constant dependency count, and Mathlib-native closure layer",
