# Bateman Horn Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/bateman-horn-conjecture-canonical-lane-mathlib.git
cd bateman-horn-conjecture-canonical-lane-mathlib
lake exe
lake build
```
